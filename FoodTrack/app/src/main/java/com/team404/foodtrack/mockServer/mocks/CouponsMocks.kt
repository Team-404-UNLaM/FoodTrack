...
object CouponsMocks {
    ...
    fun getCouponsMocks() : List<Coupon> {
        ...
        val coupon1 = Coupon.Builder()
            ...
            .couponImg("https://bigpons.com.ar/productos/20210422181717.jpeg")
            .discount(0.3)
        ...
        val coupon2 = Coupon.Builder()
            ...
            .couponImg("https://bigpons.com.ar/productos/20210422181006.jpeg")
            .minimumPrice(500.0)
            .discount(0.2)
            .maximumDiscount(500.0)
            .tags(listOf(MarketTypes.BAR, MarketTypes.RESTAURANT))
            .build()
