...
object MenuItemsMocks {
    ...
    fun getMenuItemsMocks() : List<MenuItem> {
        ...
        val products10 = productRepository.searchByIds(listOf(171717171717L, 272727272727L))
        val products11 = productRepository.searchByIds(listOf(181818181818L, 191919191919L))
        val products12 = productRepository.searchByIds(listOf(202020202020L, 343434343434L))
        val products13 = productRepository.searchByIds(listOf(212121212121L, 353535353535L))
        val products14 = productRepository.searchByIds(listOf(222222222222L, 232323232323L))
        val products15 = productRepository.searchByIds(listOf(282828282828L, 292929292929L))
        val products16 = productRepository.searchByIds(listOf(303030303030L, 313131313131L))
        val products17 = productRepository.searchByIds(listOf(323232323232L, 333333333333L))
        val products18 = productRepository.searchByIds(listOf(363636363636L, 373737373737L))
